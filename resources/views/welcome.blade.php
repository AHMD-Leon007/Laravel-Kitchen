            ...
            <div class="item">
                <div class="container">
                    <div class="header-content">
                        <h1 class="header-title" style="color: #fff; font-size: 72px; font-weight: 400;">{{ $slider->title }}</h1>
                        <p class="header-sub-title" style="color: #fff; font-size: 36px;">{{ $slider->sub_title }}</p>
                    </div> <!-- /.header-content -->
                </div>
            </div>
            @endforeach
